        ...
        this.each(function(i, val) {
            ...
            function files_added(files) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    // var modal = document.querySelector('#modalUpload')
                    ...
                    if(layout == "thumbnails") {
                        ...
                        uploader_id = 'modalUpload'
                        modal = $('#' + uploader_id + ' .modal-body')
                        modal.html('')
                        var fileInfo = '<div class="input_file"><label class="files_container feature_row_bg_color up"><span class="icon icon-selected"><span class="icon icon-selected-row"></span></span><span class="file_uploaded" title="login-bg.jpg">login-bg.jpg</span><span class="date_time"><span class="date">'+ fileSize +'</span></span></label></div>'
                        modal.append(fileInfo)
                        var fileItem = '<div id="selected_file_' + files_index + '" class="preview_img"><div class="thumbnail"></div></div>'
                        modal.append(fileItem);
                        preview_file(files[i],files_index);
                        $('#modalUpload').modal('show')
                        
                        $('.js_load').on('click', function(){
                            alert()
